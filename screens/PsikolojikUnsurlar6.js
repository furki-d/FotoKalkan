...
const PsikolojikUnsurlar6 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.psikolojikUnsurlar23}>
      <Pressable
      ...
      <View style={styles.destekParent}>
        <Text style={[styles.destek, styles.destekTypo]}>
          Sesli Mesajlar ve Podcastler
        </Text>
      ...
      <Image
        style={styles.psikolojikUnsurlar23Child}
        resizeMode="cover"
        source={require("../assets/group-108.png")}
      />
      <View style={[styles.psikolojikUnsurlar23Inner, styles.groupChildLayout]}>
      ...
      <Image
        style={styles.psikolojikUnsurlar23Item}
        resizeMode="cover"
        source={require("../assets/group-71.png")}
      />
      <Text style={[styles.destek2, styles.destekTypo]}>
...
export default PsikolojikUnsurlar6;
