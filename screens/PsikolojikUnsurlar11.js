...
const PsikolojikUnsurlar11 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.psikolojikUnsurlar41}>
      <Pressable
      ...
      <Image
        style={styles.psikolojikUnsurlar41Child}
        resizeMode="cover"
        source={require("../assets/group-108.png")}
      />
      <View style={[styles.psikolojikUnsurlar41Inner, styles.groupChildLayout]}>
      ...
      <Image
        style={styles.psikolojikUnsurlar41Item}
        resizeMode="cover"
        source={require("../assets/group-71.png")}
      />
      <Text style={[styles.etkinlikler, styles.etkinliklerTypo]}>
        Psikolojik Bilgilendirmeler
      </Text>
      <View style={styles.image10} />
      <Text style={[styles.alanndaYetkinKiilerce, styles.etkinliklerTypo]}>
        Alanında yetkin kişilerce yapılan bilgilendirmelere örnekler
      </Text>
      <Pressable
...
export default PsikolojikUnsurlar11;
