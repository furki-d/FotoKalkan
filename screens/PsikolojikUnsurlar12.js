...
const PsikolojikUnsurlar12 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.psikolojikUnsurlar42}>
      <Pressable
      ...
      <Image
        style={styles.psikolojikUnsurlar42Child}
        resizeMode="cover"
        source={require("../assets/group-108.png")}
      />
      <View
        style={[styles.psikolojikUnsurlar42Inner, styles.groupChildLayout1]}
      >
      ...
      <Image
        style={styles.psikolojikUnsurlar42Item}
        resizeMode="cover"
      ...
      <View style={styles.rectangleGroup}>
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/facebook-59687644.png")}
        />
        <Image
          style={[styles.facebook5968764Icon, styles.iconLayout]}
          resizeMode="cover"
          source={require("../assets/facebook-59687645.png")}
        />
        <Image
          style={[styles.twitter5968958Icon, styles.iconLayout]}
          resizeMode="cover"
          source={require("../assets/twitter-59689582.png")}
        />
        <View style={[styles.groupChild2, styles.groupChildLayout]} />
        <Image
          style={[styles.facebook5968764Icon2, styles.groupItemPosition]}
          resizeMode="cover"
          source={require("../assets/facebook-59687646.png")}
        />
        <Image
          style={[styles.instagram2111463Icon, styles.layerX00201Layout]}
          resizeMode="cover"
          source={require("../assets/instagram-21114633.png")}
        />
      </View>
      <Image
        style={styles.iy1Icon}
        resizeMode="cover"
        source={require("../assets/iy-1.png")}
      />
      <Pressable
        style={styles.backArrow114886332}
        onPress={() => navigation.navigate("PsikolojikUnsurlar4")}
      >
        <Image
          style={styles.icon1}
          resizeMode="cover"
...
export default PsikolojikUnsurlar12;
