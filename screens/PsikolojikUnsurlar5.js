...
const PsikolojikUnsurlar5 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.psikolojikUnsurlar24}>
      <Pressable
      ...
      <Image
        style={styles.psikolojikUnsurlar24Item}
        resizeMode="cover"
        source={require("../assets/group-72.png")}
      />
      <Text style={[styles.destek, styles.destekTypo]}>Destek Grupları</Text>
      <Text style={[styles.destek1, styles.destekTypo]}>
        Daha önce yaşamış insanlarla bir arada olma
      </Text>
      <Pressable
...
export default PsikolojikUnsurlar5;
