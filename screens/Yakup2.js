    ...
    <View style={styles.yakup2}>
      ...
      <View style={[styles.yakup51, styles.yakup51Position]}>
        ...
        <View style={[styles.twitter2, styles.twitterPosition1]}>
          <Text
            style={[styles.xdekiResminFurkan, styles.twitterTypo]}
          >{`X'deki resmin Furkan `}</Text>
          <Text style={[styles.tarafndanPaylald, styles.twitterTypo]}>
            tarafından paylaşıldı
          </Text>
        </View>
        <Text style={[styles.beeni1, styles.kiiTypo]}>Furkan</Text>
        <Image
