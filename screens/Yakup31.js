...
const Yakup31 = () => {
  ...
  return (
    <View style={styles.yakup32}>
      <Image
        style={[styles.vectorIcon, styles.iconGroupLayout]}
        resizeMode="cover"
        source={require("../assets/vector2.png")}
      />
      <View style={[styles.yakup321, styles.iconPosition]}>
        <Image
          style={[styles.vectorIcon, styles.iconGroupLayout]}
          resizeMode="cover"
        ...
        />
        <View style={[styles.yakup32Inner, styles.profileiconPosition]}>
          <View style={[styles.yakup321, styles.iconPosition]}>
            <Image
              style={[styles.vectorIcon, styles.iconGroupLayout]}
              resizeMode="cover"
            ...
            <Image
              ...
              resizeMode="cover"
              source={require("../assets/group-3014.png")}
            />
        ...
        <Image
          style={[styles.yakup32Child, styles.iconGroupLayout]}
          resizeMode="cover"
        ...
        <View style={[styles.grup1, styles.grup1Layout]}>
          ...
          <Text style={[styles.balk1, styles.balkTypo]}>
            Son Paylaştığım Resimler İnstagram
          </Text>
          <Text style={[styles.instagram, styles.instagramTypo1]}>
            İnstagram
          </Text>
          <Text style={[styles.instagram1, styles.instagramTypo1]}>
            İnstagram
          </Text>
          <Image
        ...
        <Text style={[styles.balk11, styles.balkTypo]}>
          Son Şüpheli Davranışlar İnstagram
        </Text>
        <Text style={[styles.instagram2, styles.instagramTypo]}>İnstagram</Text>
        <Text style={[styles.instagram3, styles.instagramTypo]}>İnstagram</Text>
        <Image
          style={[styles.instagramIcon1, styles.instagramIconPosition]}
          resizeMode="cover"
          source={require("../assets/instagram2.png")}
        />
        <Image
          style={[styles.instagramIcon2, styles.instagramIconLayout]}
          resizeMode="cover"
          source={require("../assets/instagram3.png")}
        />
        <Image
          style={[styles.instagramIcon3, styles.instagramIconLayout]}
          resizeMode="cover"
        ...
        />
        <Image
          style={[styles.yakup32Item, styles.iconGroupLayout]}
          resizeMode="cover"
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/altlogo2.png")}
        />
        <Image
