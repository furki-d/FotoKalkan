  ...
  return (
    <View style={styles.whatsapp}>
      ...
      <View style={styles.group}>
        <Text style={styles.whatsapp1}>Whatsapp</Text>
      </View>
      ...
      >
        <View style={[styles.vectorParent, styles.vectorGroupPosition]}>
          <Image
            style={[styles.vectorIcon, styles.iconGroupLayout]}
            resizeMode="cover"
      ...
      />
      <View style={[styles.groupParent, styles.vectorGroupPosition]}>
        <Image
      ...
      <Image
        style={[styles.whatsapp36700512Icon, styles.iconPosition]}
        resizeMode="cover"
        source={require("../assets/whatsapp-3670051-2.png")}
      />
    </View>
  );
};
