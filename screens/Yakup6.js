...
const Yakup6 = () => {
  ...
  return (
    <View style={styles.yakup3}>
      ...
      />
      <View style={[styles.yakup51, styles.yakup51Position]}>
        <Image
          style={[styles.vectorIcon, styles.iconGroupLayout]}
          resizeMode="cover"
        ...
        />
        <Image
          style={[styles.yakup51Item, styles.iconPosition]}
          resizeMode="cover"
        ...
        <Image
          ...
          source={require("../assets/group34.png")}
        />
        <View style={[styles.twitter2, styles.twitterPosition1]}>
          <Text
            style={[styles.facebooktakiResmin, styles.twitterTypo]}
          >{`Facebooktaki resmin  `}</Text>
          <Text style={[styles.yenindenPaylald, styles.twitterTypo]}>
            yeninden paylaşıldı.
          </Text>
        </View>
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/3883.png")}
        />
        <Image
