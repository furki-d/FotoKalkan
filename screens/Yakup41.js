...
const Yakup41 = () => {
  ...
  return (
    <View style={styles.yakup42}>
      <Image
        style={[styles.vectorIcon, styles.iconGroupLayout]}
        resizeMode="cover"
        source={require("../assets/vector2.png")}
      />
      <View style={[styles.yakup421, styles.paylaldPosition]}>
        <Image
          style={[styles.vectorIcon, styles.iconGroupLayout]}
          resizeMode="cover"
        ...
        <Image
          style={[styles.yakup42Child, styles.iconGroupLayout]}
          resizeMode="cover"
        ...
        />
        <Image
          style={[styles.yakup42Item, styles.iconGroupLayout]}
          resizeMode="cover"
        ...
        <Image
          ...
          source={require("../assets/group34.png")}
        />
        <Text style={[styles.twitter, styles.balk1Typo]}>X'de paylaşıldı</Text>
        ...
        />
        <Image
          style={[styles.yakup42Inner, styles.iconGroupLayout]}
          resizeMode="cover"
